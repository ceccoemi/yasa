...
TEST(SqliteDictionaryTest, sizeOfEmptyDictionary) {
  ...
  SqliteHandler::QueryResult queryResult{{"COUNT(*)", {"0"}}};
...
TEST(SqliteDictionaryTest, sizeOfASqliteDictionaryTwoWords) {
  ...
  EXPECT_CALL(handler, query(AllOf(HasSubstr("COUNT"), HasSubstr("positives"))))
      .Times(3)
      .WillOnce(Return(SqliteHandler::QueryResult{{"COUNT(*)", {"0"}}}))
      .WillRepeatedly(Return(SqliteHandler::QueryResult{{"COUNT(*)", {"1"}}}));
  EXPECT_CALL(handler, query(AllOf(HasSubstr("COUNT"), HasSubstr("negatives"))))
      .Times(3)
      .WillOnce(Return(SqliteHandler::QueryResult{{"COUNT(*)", {"0"}}}))
      .WillOnce(Return(SqliteHandler::QueryResult{{"COUNT(*)", {"0"}}}))
...
TEST(SqliteDictionaryTest, positivesCount) {
  ...
  EXPECT_CALL(handler, query(AllOf(HasSubstr("COUNT"), HasSubstr("positives"))))
      .Times(3)
      .WillOnce(Return(SqliteHandler::QueryResult{{"COUNT(*)", {"0"}}}))
      .WillOnce(Return(SqliteHandler::QueryResult{{"COUNT(*)", {"1"}}}))
      .WillRepeatedly(Return(SqliteHandler::QueryResult{{"COUNT(*)", {"3"}}}));
...
TEST(SqliteDictionaryTest, positivesCountOfAWord) {
  ...
  EXPECT_CALL(handler, query(AllOf(HasSubstr("COUNT"), HasSubstr("positives"))))
      ...
      .WillOnce(Return(SqliteHandler::QueryResult{{"COUNT(*)", {"0"}}}))
      .WillOnce(Return(SqliteHandler::QueryResult{{"COUNT(*)", {"1"}}}))
      .WillOnce(Return(SqliteHandler::QueryResult{{"COUNT(*)", {"3"}}}))
      .WillOnce(Return(SqliteHandler::QueryResult{{"COUNT(*)", {"0"}}}));
...
TEST(SqliteDictionaryTest, resetDictionary) {
  ...
  EXPECT_CALL(handler, query(AllOf(HasSubstr("COUNT"), HasSubstr("positives"))))
      .Times(2)
      .WillOnce(Return(SqliteHandler::QueryResult{{"COUNT(*)", {"1"}}}))
      .WillRepeatedly(Return(SqliteHandler::QueryResult{{"COUNT(*)", {"0"}}}));
  EXPECT_CALL(handler, query(AllOf(HasSubstr("COUNT"), HasSubstr("negatives"))))
      .Times(2)
      .WillOnce(Return(SqliteHandler::QueryResult{{"COUNT(*)", {"1"}}}))
      .WillRepeatedly(Return(SqliteHandler::QueryResult{{"COUNT(*)", {"0"}}}));
